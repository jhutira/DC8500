...
Libraries/eeprom/%.o Libraries/eeprom/%.su Libraries/eeprom/%.cyclo: ../Libraries/eeprom/%.c Libraries/eeprom/subdir.mk
...
clean: clean-Libraries-2f-eeprom

clean-Libraries-2f-eeprom:
	-$(RM) ./Libraries/eeprom/eeprom.cyclo ./Libraries/eeprom/eeprom.d ./Libraries/eeprom/eeprom.o ./Libraries/eeprom/eeprom.su

.PHONY: clean-Libraries-2f-eeprom
