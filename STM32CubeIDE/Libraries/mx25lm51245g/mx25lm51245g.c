/**
  ...
  * @brief   This file provides the MX25LM51245G XSPI drivers.
  ******************************************************************************
  * @attention
  *
...
int32_t MX25LM51245G_GetFlashInfo(MX25LM51245G_Info_t *pInfo)
{
  ...
  pInfo->EraseSectorSize        = MX25LM51245G_BLOCK_64K;
  pInfo->EraseSectorsNumber     = (MX25LM51245G_FLASH_SIZE / MX25LM51245G_BLOCK_64K);
  pInfo->EraseSubSectorSize     = MX25LM51245G_BLOCK_4K;
  pInfo->EraseSubSectorNumber   = (MX25LM51245G_FLASH_SIZE / MX25LM51245G_BLOCK_4K);
  pInfo->EraseSubSector1Size    = MX25LM51245G_BLOCK_4K;
  pInfo->EraseSubSector1Number  = (MX25LM51245G_FLASH_SIZE / MX25LM51245G_BLOCK_4K);
...
int32_t MX25LM51245G_ReadSTR(XSPI_HandleTypeDef *Ctx, MX25LM51245G_Interface_t Mode,
                             MX25LM51245G_AddressWidth_t AddressWidth, uint8_t *pData, uint32_t ReadAddr, uint32_t Size)
{
  XSPI_RegularCmdTypeDef s_command = {0};

  /* OPI mode and 3-bytes address size not supported by memory */
  if ((Mode == MX25LM51245G_OPI_MODE) && (AddressWidth == MX25LM51245G_3BYTES_SIZE))
  {
    return MX25LM51245G_ERROR;
  }
  ...
  s_command.InstructionWidth = (Mode == MX25LM51245G_SPI_MODE)
                                   ...
                                   : HAL_XSPI_INSTRUCTION_16_BITS;
  s_command.Instruction = (Mode == MX25LM51245G_SPI_MODE)
                              ? ((AddressWidth == MX25LM51245G_3BYTES_SIZE)
  ...
  s_command.AddressWidth = (AddressWidth == MX25LM51245G_3BYTES_SIZE)
...
int32_t MX25LM51245G_PageProgram(XSPI_HandleTypeDef *Ctx, MX25LM51245G_Interface_t Mode,
								MX25LM51245G_AddressWidth_t AddressWidth, uint8_t *pData, uint32_t WriteAddr,
                                uint32_t Size)
{
  XSPI_RegularCmdTypeDef s_command = {0};
...
int32_t MX25LM51245G_BlockErase(XSPI_HandleTypeDef *Ctx, MX25LM51245G_Interface_t Mode, MX25LM51245G_Transfer_t Rate,
								MX25LM51245G_AddressWidth_t AddressWidth, uint32_t BlockAddress,
								MX25LM51245G_Erase_t BlockSize)
{
  ...
  switch (Mode)
  {
    case MX25LM51245G_OPI_MODE :
      ...
      {
        s_command.Instruction = MX25LM51245G_OCTA_BLOCK_ERASE_64K_CMD;
      }
      else
      {
        s_command.Instruction = MX25LM51245G_OCTA_SECTOR_ERASE_4K_CMD;
      }
      break;
    ...
    default:
      if (BlockSize == MX25LM51245G_ERASE_64K)
      {
        s_command.Instruction = (AddressWidth == MX25LM51245G_3BYTES_SIZE)
                                ? MX25LM51245G_BLOCK_ERASE_64K_CMD
                                : MX25LM51245G_4_BYTE_BLOCK_ERASE_64K_CMD;
      }
      else
      {
        s_command.Instruction = (AddressWidth == MX25LM51245G_3BYTES_SIZE)
                                ? MX25LM51245G_SECTOR_ERASE_4K_CMD
                                : MX25LM51245G_4_BYTE_SECTOR_ERASE_4K_CMD;
      }
      break;
  }
...
int32_t MX25LM51245G_EnableSTRMemoryMappedMode(XSPI_HandleTypeDef *Ctx, MX25LM51245G_Interface_t Mode,
                                              MX25LM51245G_AddressWidth_t AddressWidth)
{
  XSPI_RegularCmdTypeDef s_command = {0};
