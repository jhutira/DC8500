...
const uint8_t* video_SampleVideo2_216x216_bin_start;
const uint8_t* video_Test_bin_start;
...
void setupVideoDecoder(touchgfx::HAL& hal)
{
    ...
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "SampleVideo2_216x216.bin"), &video_SampleVideo2_216x216_bin_start, video_SampleVideo2_216x216_bin_length);
    setupVideo(static_cast<touchgfx::HALSDL2&>(hal).localFileName(videoFileName, 400, "Test.bin"), &video_Test_bin_start, video_Test_bin_length);
}
...
void setupSimulator(int argc, char** argv, touchgfx::HAL& hal)
{
    ...
    static_cast<touchgfx::HALSDL2&>(hal).setWindowTitle("DC8500");
