...
exchanScreenViewBase::exchanScreenViewBase() :
    buttonCallback(this, &exchanScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_EXCHANDLG));
    add(dialogLabel);
...
void exchanScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
}

void exchanScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
