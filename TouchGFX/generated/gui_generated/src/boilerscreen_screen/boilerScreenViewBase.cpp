...
boilerScreenViewBase::boilerScreenViewBase() :
    buttonCallback(this, &boilerScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setPosition(225, 11, 350, 36);
    dialogLabel.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    dialogLabel.setLinespacing(0);
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_BOILERDLG));
    add(dialogLabel);
...
void boilerScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
}

void boilerScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
