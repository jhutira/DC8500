...
pflapScreenViewBase::pflapScreenViewBase() :
    buttonCallback(this, &pflapScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_PFLAPDLG));
    add(dialogLabel);
...
void pflapScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
}

void pflapScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
