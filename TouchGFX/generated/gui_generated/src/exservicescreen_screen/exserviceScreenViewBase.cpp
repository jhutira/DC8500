...
exserviceScreenViewBase::exserviceScreenViewBase() :
    buttonCallback(this, &exserviceScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_EXSERVICEDLG));
    add(dialogLabel);
}
...
void exserviceScreenViewBase::setupScreen()
{

}

void exserviceScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &backBtn)
    {
        //backBtn_itt
