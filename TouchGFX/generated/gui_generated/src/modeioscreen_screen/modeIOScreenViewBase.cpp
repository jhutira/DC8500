...
modeIOScreenViewBase::modeIOScreenViewBase() :
    buttonCallback(this, &modeIOScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_MODEIODLG));
    add(dialogLabel);
...
void modeIOScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
}

void modeIOScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
