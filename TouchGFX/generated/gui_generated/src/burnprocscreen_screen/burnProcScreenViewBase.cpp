...
burnProcScreenViewBase::burnProcScreenViewBase() :
    buttonCallback(this, &burnProcScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_BURNPROCDLG));
    add(dialogLabel);
...
void burnProcScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
}

void burnProcScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
