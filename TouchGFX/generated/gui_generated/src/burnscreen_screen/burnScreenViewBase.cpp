...
burnScreenViewBase::burnScreenViewBase() :
    buttonCallback(this, &burnScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_BURNDLG));
    add(dialogLabel);
...
void burnScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
    questionDlgCont.initialize();
}

void burnScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
