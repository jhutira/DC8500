...
accumScreenViewBase::accumScreenViewBase() :
    buttonCallback(this, &accumScreenViewBase::buttonCallbackHandler)
{
    ...
    dialogLabel.setPosition(225, 12, 350, 36);
    dialogLabel.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    dialogLabel.setLinespacing(0);
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_ACCUMDLG));
    add(dialogLabel);
...
void accumScreenViewBase::setupScreen()
{
    editNumDlgCont.initialize();
}

void accumScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
