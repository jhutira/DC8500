...
energyScreenViewBase::energyScreenViewBase() :
    buttonCallback(this, &energyScreenViewBase::buttonCallbackHandler)
{
    ...
    clrAEngBtn.setXY(39, 320);
    clrAEngBtn.setBitmaps(touchgfx::Bitmap(BITMAP_BTN144X70_ID), touchgfx::Bitmap(BITMAP_BTN144X70_P_ID));
    clrAEngBtn.setLabelText(touchgfx::TypedText(T_S_CLEARAENGBTN));
    clrAEngBtn.setLabelColor(touchgfx::Color::getColorFromRGB(5, 37, 245));
    clrAEngBtn.setLabelColorPressed(touchgfx::Color::getColorFromRGB(255, 255, 255));
    clrAEngBtn.setAction(buttonCallback);
    add(clrAEngBtn);
    ...
    dialogLabel.setTypedText(touchgfx::TypedText(T_S_ENERGYDLG));
    add(dialogLabel);

    scrollCnt.setPosition(10, 70, 780, 230);
...
void energyScreenViewBase::setupScreen()
{
    questionDlgCont.initialize();
    editNumDlgCont.initialize();
}

void energyScreenViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &okBtn)
    {
        //okBtn_itt
    ...
    {
        //clearEngBtn_itt
        //When clrAEngBtn clicked call virtual function
        //Call clearEngBtn_clicked
        clearEngBtn_clicked();
    }
}
