...
pflapScreenView::pflapScreenView() :
	textAreaClickedCallback(this, &pflapScreenView::textAreaClickHandler)
{

}

void pflapScreenView::setupScreen()
{
    pflapScreenViewBase::setupScreen();
	...
	iPID_CP.setupListItem(20, T_S_PID_CP, 0, " ", eTypeValue::tUInt_1Dec);
...
void pflapScreenView::tearDownScreen()
{
    pflapScreenViewBase::tearDownScreen();
}

void pflapScreenView::initPIDValues(pidConfig_st pid_conf)
{
...
void pflapScreenView::textAreaClickHandler(const TextAreaWithOneWildcard& src, const ClickEvent& e)
{
...
void pflapScreenView::okBtn_clicked()
{
