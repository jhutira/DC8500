...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_G1_Pin|TP_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_G1_Pin TP_RST_Pin */
  GPIO_InitStruct.Pin = LED_G1_Pin|TP_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : PA0 ESP32_DI1_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0|ESP32_DI1_Pin;
