...
void MX_HSPI1_Init(void)
{
  ...
  // Reset flash
   MX25LM51245G_ResetEnable(&hxspi1, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER);

   MX25LM51245G_ResetMemory(&hxspi1, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER);

   HAL_Delay(MX25LM51245G_RESET_MAX_TIME);

   /* Enable write operations */
   MX25LM51245G_WriteEnable(&hxspi1, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER);

   /* Write Configuration register 2 (with new dummy cycles) */
   MX25LM51245G_WriteCfg2Register(&hxspi1, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER, MX25LM51245G_CR2_REG3_ADDR, MX25LM51245G_CR2_DC_6_CYCLES);

   /* Enable write operations */
   MX25LM51245G_WriteEnable(&hxspi1, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER);

   /* Write Configuration register 2 (with Octal I/O SPI protocol) */
   MX25LM51245G_WriteCfg2Register(&hxspi1, MX25LM51245G_SPI_MODE, MX25LM51245G_STR_TRANSFER, MX25LM51245G_CR2_REG1_ADDR, MX25LM51245G_CR2_DOPI);

   /* Wait that the configuration is effective and check that memory is ready */
   HAL_Delay(MX25LM51245G_WRITE_REG_MAX_TIME);

   /* Check if memory is ready */
   MX25LM51245G_AutoPollingMemReady(&hxspi1, MX25LM51245G_OPI_MODE, MX25LM51245G_DTR_TRANSFER);

   /* Check the configuration has been correctly done */
//   MX25LM51245G_ReadCfg2Register(&hxspi1, MX25LM51245G_OPI_MODE, MX25LM51245G_DTR_TRANSFER, MX25LM51245G_CR2_REG1_ADDR, reg);

   MX25LM51245G_EnableDTRMemoryMappedMode(&hxspi1, MX25LM51245G_OPI_MODE);
